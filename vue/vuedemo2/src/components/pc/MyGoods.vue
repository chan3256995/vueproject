              ...
              <tr style="background: white" v-for="(goods,index2) in goods_list">
                ...
                <td>
                 ...
                 <td>
                  ...
                  <div style="border: grey solid 1px;margin-bottom: 2px"><label style="float: left">尺码</label><input style="width: 5em"  v-model="goods.goods_size"><button @click="replace_goods_color_size_string(goods)" >字符替换</button></div>
                </td>
                <td>
  ...
  import  axios  from 'axios'
    ...
    export default {
      ...
      methods:{
        ...
        //替换颜色尺码字符
        replace_goods_color_size_string(my_goods){
          // my_goods['replace_obj_list'] =  [
          //   { "old":"绿色",'new':"黑色连衣裙"},
          //   { "old":"XL",'new':"7777"},
          //
          // ]
            this.$alertGoodsColorSizeString.showMsgBox({
                  title: '修改商品信息',
                  content: '',
                  isShowInput: true,
                  myGoods:my_goods,
