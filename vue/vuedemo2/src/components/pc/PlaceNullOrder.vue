      ...
      <li class = "items_li" v-for="(item,index) in order_obj['order_list']" >
       <div class="review_order_div" >
         <div class = "order_div global_background ">
            ...
            <label   v-if="item.tb_seller_wangwang_id!==undefined && item.tb_seller_wangwang_id!==''" style="color:red;margin-left: 1em">卖家账号:{{item.tb_seller_wangwang_id}}</label>
             ...
             if("1000" === result.code){
               ...
               if(null_order_tem_list!==null){
                 ...
                 for(let i = 0;i<null_order_tem_list.length;i++){
                    ...
                    let tb_seller_wangwang_id = null_order_tem_list[i].tb_seller_wangwang_id
                    let addressObj = {
                    ...
                    new_order_list_data.push({"tb_seller_wangwang_id":tb_seller_wangwang_id,"address":addressObj, "tb_order_number":null_order_tem_list[i].tb_order_number,"logistics":  this.selected_logistics,"null_order_tem_id":null_order_tem_id})
