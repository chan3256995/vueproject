  ...
  export default {
    ...
    methods: {
      ...
      get_skw_goods_details(url){
          let  result = this.mcommon_get_skw_goods_details2(url)
          console.log("result--->",result)

          this.goods_obj['goods_url'] = result['goods_url'].trim()
          this.goods_obj['shop_name'] = result['shop_name'].trim()
          this.goods_obj['market_name'] = result['market_name'].trim()
          this.goods_obj['floor'] = result['floor'].trim()
          this.goods_obj['shop_stalls_no'] =  result['shop_stalls_no'].trim()

           result['shop_stalls_no'] =  this.mcommon_replace_all(result['art_no'].trim())

          this.goods_obj['art_no'] = result['shop_stalls_no'].trim()
          this.goods_obj['main_img'] = result['main_img'].trim()
          this.goods_obj['goods_color'] = result['goods_color'].trim()
          this.goods_obj['goods_size'] = result['goods_size'].trim()
          this.goods_obj['goods_price'] = result['goods_price'].trim()
