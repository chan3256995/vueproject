<template>
  <div style="width: 100%;margin: 0 auto; ">
    ...
    <div class="nav_div">
      <router-link class="nav" to = "/pc/nullPackageHome/pNullOrder" >下空包订单</router-link>
      <router-link class="nav" to = "/pc/nullPackageHome/pMyNullOrder" >我的空包订单</router-link>
